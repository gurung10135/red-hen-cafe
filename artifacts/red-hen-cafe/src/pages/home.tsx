          ...
          <div className="container px-6 mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <motion.div
                ...
                className="col-span-2 md:col-span-1 aspect-square rounded-2xl overflow-hidden group"
              >
                <img src={pastryImg} alt="House-made pastry with chocolate drizzle" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
              </motion.div>
              <motion.div
